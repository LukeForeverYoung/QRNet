...
def get_args_parser():
    ...
    parser.add_argument('--topk_method', default='gumbel',type=str,
                        help="Use gumbel or topk sampling")
    ...
    parser.add_argument('--disable_channel', action='store_true',
                        help="If true, use amp training")
    parser.add_argument('--swin_checkpoint', default='models/swin_model/mask_rcnn_swin_small_patch4_window7.pth',type=str)
    return parser
...
def main(args):
    ...
    if args.distributed:
        #sampler_test = DistributedSampler(dataset_test, shuffle=args.visualize)
